...
const HomeLandingPage = () => {
  return (
    <div>
      <Box>
        <Grid container style={{background: "linear-gradient(90deg, hsla(0, 0%, 100%, 1) 0%, hsla(86, 21%, 72%, 1) 45%, hsla(87, 29%, 54%, 1) 100%)",height:'50vh'}}>
            <Grid item xs={12}>
               <Grid container style={{display:'flex',alignItems:'center'}}>
                <Grid item xs={2.5} mt={12}>
                  <img src="./images/Group-1.png" alt="LoginImage" style={{ height: "20vh",marginLeft:'5rem' }}/>
                </Grid>
