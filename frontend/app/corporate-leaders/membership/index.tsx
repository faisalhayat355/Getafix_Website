  ...
  return (
    <Box>
        <Grid container>
            ...
            <Grid item xs={12} style={{display:'flex',justifyContent:'space-around'}} mt={2}>
            <Typography style={{fontSize:'2.5rem',fontWeight:'bold',color:'#1e2a5e'}}>Membership</Typography>
            </Grid>
           <Grid item xs={4}></Grid>

           <Grid item xs={5} style={{display:'flex',justifyContent:'space-around',alignItems:'center'}} mt={3}>
            <Button variant='contained'>Categories & Fees</Button>
            <Button variant='contained'>Benefits</Button>
            <Button variant='contained'>FAQs</Button>
